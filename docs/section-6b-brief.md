...
- `docs/design-prototypes/dist/Nexus Round 7b.html` — visual reference prototype (4 states: All collapsed · Assembly drawer open · Leaf drawer open · Empty tiers / preset picker)
